...
public class BugSAT17 {
    ...
    @Test(timeout = 10000)
    public void testSingleLit() throws Exception, ContradictionException, TimeoutException {
        boolean o_testSingleLit__1 = this.solver.isSatisfiable(new VecInt(new int[]{ -2 }));
        Assert.assertFalse(o_testSingleLit__1);
    }
