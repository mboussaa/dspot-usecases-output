...
public final class AmplLubyRestarts implements RestartStrategy {
    ...
    public AmplLubyRestarts() {
        this(AmplLubyRestarts.DEFAULT_LUBY_FACTOR);
    }

    public AmplLubyRestarts(int factor) {
        setFactor(factor);
    }
