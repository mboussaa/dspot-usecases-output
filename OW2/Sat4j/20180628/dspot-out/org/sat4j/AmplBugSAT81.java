...
public class AmplBugSAT81 {
    ...
    public void testSimplePhoneSATSmall() throws Exception, ContradictionException, TimeoutException {
        ...
        Assert.assertEquals("", ((org.sat4j.core.VecInt)clause0).toString());
        Assert.assertTrue(((org.sat4j.core.VecInt)clause0).isEmpty());
        IVecInt o_testSimplePhoneSATSmall__4 = clause0.push(1);
        Assert.assertEquals("1", ((org.sat4j.core.VecInt)o_testSimplePhoneSATSmall__4).toString());
        Assert.assertEquals(1, ((int) (((org.sat4j.core.VecInt)o_testSimplePhoneSATSmall__4).hashCode())));
        Assert.assertFalse(((org.sat4j.core.VecInt)o_testSimplePhoneSATSmall__4).isEmpty());
        IConstr o_testSimplePhoneSATSmall__5 = solver.addClause(clause0);
        Assert.assertEquals(0.0, ((double) (((org.sat4j.minisat.constraints.cnf.UnitClause)o_testSimplePhoneSATSmall__5).getActivity())), 0.1);
        Assert.assertTrue(((org.sat4j.minisat.constraints.cnf.UnitClause)o_testSimplePhoneSATSmall__5).isSatisfied());
        Assert.assertEquals("1", ((org.sat4j.minisat.constraints.cnf.UnitClause)o_testSimplePhoneSATSmall__5).toString());
        VecInt clause1 = new VecInt();
        Assert.assertEquals("", ((org.sat4j.core.VecInt)clause1).toString());
        Assert.assertTrue(((org.sat4j.core.VecInt)clause1).isEmpty());
        IVecInt o_testSimplePhoneSATSmall__9 = clause1.push(1);
        Assert.assertEquals("1", ((org.sat4j.core.VecInt)o_testSimplePhoneSATSmall__9).toString());
        Assert.assertEquals(1, ((int) (((org.sat4j.core.VecInt)o_testSimplePhoneSATSmall__9).hashCode())));
        Assert.assertFalse(((org.sat4j.core.VecInt)o_testSimplePhoneSATSmall__9).isEmpty());
        IVecInt o_testSimplePhoneSATSmall__10 = clause1.push((-2));
        Assert.assertEquals("1,-2", ((org.sat4j.core.VecInt)o_testSimplePhoneSATSmall__10).toString());
        Assert.assertEquals(0, ((int) (((org.sat4j.core.VecInt)o_testSimplePhoneSATSmall__10).hashCode())));
        Assert.assertFalse(((org.sat4j.core.VecInt)o_testSimplePhoneSATSmall__10).isEmpty());
