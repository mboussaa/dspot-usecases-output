...
public class TestFreeId {
    ...
    public void testIncrementalFeed() throws Exception, ContradictionException {
        ...
        int[] array_32809935 = new int[]{6,11};
        	int[] array_226753950 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalBinaryClause)o_testIncrementalFeed__7).getLits();
        	for(int ii = 0; ii <array_32809935.length; ii++) {
        		org.junit.Assert.assertEquals(array_32809935[ii], array_226753950[ii]);
        	};
        ...
        int[] array_515061022 = new int[]{2,5};
        	int[] array_1089232265 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalBinaryClause)o_testIncrementalFeed__13).getLits();
        	for(int ii = 0; ii <array_515061022.length; ii++) {
        		org.junit.Assert.assertEquals(array_515061022[ii], array_1089232265[ii]);
        	};
        ...
        int[] array_337731290 = new int[]{63,2000};
        	int[] array_1983218481 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalBinaryClause)o_testIncrementalFeed__20).getLits();
        ...
        Assert.assertFalse(((VecInt) (o_testIncrementalFeed__4)).isEmpty());
        int[] array_1020758105 = new int[]{6,11};
        	int[] array_292790849 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalBinaryClause)o_testIncrementalFeed__7).getLits();
        ...
        Assert.assertFalse(((VecInt) (o_testIncrementalFeed__10)).isEmpty());
        int[] array_1816246477 = new int[]{2,5};
        	int[] array_987720869 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalBinaryClause)o_testIncrementalFeed__13).getLits();
        ...
        Assert.assertEquals(484, ((int) (((VecInt) (o_testIncrementalFeed__17)).hashCode())));
        Assert.assertFalse(((VecInt) (o_testIncrementalFeed__17)).isEmpty());
        int[] array_490514772 = new int[]{63,2000};
        	int[] array_432943687 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalBinaryClause)o_testIncrementalFeed__20).getLits();
