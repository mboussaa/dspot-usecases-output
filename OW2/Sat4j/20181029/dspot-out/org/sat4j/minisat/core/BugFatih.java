...
public class BugFatih {
    ...
    public void testBugReport() throws Exception, ContradictionException, TimeoutException {
        ...
        int[] array_1602401835 = new int[]{2,4,8};
        	int[] array_692964736 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testBugReport__10).getLits();
        ...
        int[] array_1681360969 = new int[]{2,6,10};
        	int[] array_47294426 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testBugReport__12).getLits();
        ...
        int[] array_2133363011 = new int[]{4,6,12};
        	int[] array_1140420648 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testBugReport__14).getLits();
        ...
        int[] array_1354204545 = new int[]{2,4,6};
        	int[] array_231660145 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testBugReport__36).getLits();
        ...
        int[] array_2107232173 = new int[]{4,8};
        	int[] array_888302443 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalBinaryClause)o_testBugReport__38).getLits();
        ...
        Assert.assertEquals(0.0, ((double) (((OriginalWLClause) (o_testBugReport__10)).getActivity())), 0.1);
        Assert.assertFalse(((OriginalWLClause) (o_testBugReport__10)).isSatisfied());
        int[] array_2097260477 = new int[]{4,8,2};
        	int[] array_1454982327 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testBugReport__10).getLits();
        ...
        Assert.assertEquals(0.0, ((double) (((OriginalWLClause) (o_testBugReport__12)).getActivity())), 0.1);
        Assert.assertFalse(((OriginalWLClause) (o_testBugReport__12)).isSatisfied());
        int[] array_1135764624 = new int[]{6,10,2};
        	int[] array_1944614705 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testBugReport__12).getLits();
        ...
        Assert.assertEquals(0.0, ((double) (((OriginalWLClause) (o_testBugReport__14)).getActivity())), 0.1);
        Assert.assertFalse(((OriginalWLClause) (o_testBugReport__14)).isSatisfied());
        int[] array_564448070 = new int[]{4,6,12};
        	int[] array_1116118474 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testBugReport__14).getLits();
        ...
        Assert.assertEquals(0.0, ((double) (((OriginalWLClause) (o_testBugReport__36)).getActivity())), 0.1);
        Assert.assertFalse(((OriginalWLClause) (o_testBugReport__36)).isSatisfied());
        int[] array_696072730 = new int[]{4,6,2};
        	int[] array_1141906742 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testBugReport__36).getLits();
        ...
        Assert.assertEquals(0.0, ((double) (((OriginalBinaryClause) (o_testBugReport__38)).getActivity())), 0.1);
        Assert.assertFalse(((OriginalBinaryClause) (o_testBugReport__38)).isSatisfied());
        int[] array_1279429236 = new int[]{4,8};
        	int[] array_1152296711 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalBinaryClause)o_testBugReport__38).getLits();
