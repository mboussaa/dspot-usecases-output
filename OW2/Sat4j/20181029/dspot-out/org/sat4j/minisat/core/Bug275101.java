...
public class Bug275101 {
    ...
    public void testMaxSAtIteratorIfSat() throws Exception, ContradictionException, TimeoutException {
        ...
        int[] array_864755754 = new int[]{3,5,6,8};
        	int[] array_1722450718 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testMaxSAtIteratorIfSat__14).getLits();
        ...
        int[] array_1509749032 = new int[]{3,4,10};
        	int[] array_917400259 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testMaxSAtIteratorIfSat__19).getLits();
        ...
        int[] array_2087484823 = new int[]{3,7,12};
        	int[] array_679543374 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testMaxSAtIteratorIfSat__25).getLits();
        ...
        Assert.assertEquals(0.0, ((double) (((OriginalWLClause) (o_testMaxSAtIteratorIfSat__14)).getActivity())), 0.1);
        Assert.assertFalse(((OriginalWLClause) (o_testMaxSAtIteratorIfSat__14)).isSatisfied());
        int[] array_109620927 = new int[]{3,5,6,8};
        	int[] array_403897321 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testMaxSAtIteratorIfSat__14).getLits();
        ...
        Assert.assertEquals(0.0, ((double) (((OriginalWLClause) (o_testMaxSAtIteratorIfSat__19)).getActivity())), 0.1);
        Assert.assertFalse(((OriginalWLClause) (o_testMaxSAtIteratorIfSat__19)).isSatisfied());
        int[] array_1740806952 = new int[]{3,4,10};
        	int[] array_673318014 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testMaxSAtIteratorIfSat__19).getLits();
        ...
        Assert.assertEquals(0.0, ((double) (((OriginalWLClause) (o_testMaxSAtIteratorIfSat__25)).getActivity())), 0.1);
        Assert.assertFalse(((OriginalWLClause) (o_testMaxSAtIteratorIfSat__25)).isSatisfied());
        int[] array_144344505 = new int[]{3,7,12};
        	int[] array_1690747032 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testMaxSAtIteratorIfSat__25).getLits();
    ...
    public void testMaxSAtIterator() throws Exception, ContradictionException, TimeoutException {
        ...
        int[] array_1526777105 = new int[]{3,5,6};
        	int[] array_1852731602 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testMaxSAtIterator__13).getLits();
        ...
        int[] array_1707940459 = new int[]{3,4,8};
        	int[] array_1316973585 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testMaxSAtIterator__18).getLits();
        ...
        int[] array_268709476 = new int[]{2,5,10};
        	int[] array_1565255191 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testMaxSAtIterator__23).getLits();
        ...
        int[] array_1257412961 = new int[]{2,4,12};
        	int[] array_2122754561 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testMaxSAtIterator__27).getLits();
        ...
        Assert.assertEquals(0.0, ((double) (((OriginalWLClause) (o_testMaxSAtIterator__13)).getActivity())), 0.1);
        Assert.assertFalse(((OriginalWLClause) (o_testMaxSAtIterator__13)).isSatisfied());
        int[] array_534937887 = new int[]{5,3,6};
        	int[] array_1634877861 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testMaxSAtIterator__13).getLits();
        ...
        Assert.assertEquals(0.0, ((double) (((OriginalWLClause) (o_testMaxSAtIterator__18)).getActivity())), 0.1);
        Assert.assertFalse(((OriginalWLClause) (o_testMaxSAtIterator__18)).isSatisfied());
        int[] array_1281550771 = new int[]{4,3,8};
        	int[] array_1073891162 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testMaxSAtIterator__18).getLits();
        ...
        Assert.assertEquals(0.0, ((double) (((OriginalWLClause) (o_testMaxSAtIterator__23)).getActivity())), 0.1);
        Assert.assertFalse(((OriginalWLClause) (o_testMaxSAtIterator__23)).isSatisfied());
        int[] array_1858404507 = new int[]{5,2,10};
        	int[] array_748175285 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testMaxSAtIterator__23).getLits();
        ...
        Assert.assertEquals(0.0, ((double) (((OriginalWLClause) (o_testMaxSAtIterator__27)).getActivity())), 0.1);
        Assert.assertFalse(((OriginalWLClause) (o_testMaxSAtIterator__27)).isSatisfied());
        int[] array_1532662278 = new int[]{4,2,12};
        	int[] array_1538493509 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_testMaxSAtIterator__27).getLits();
