...
public class TestMaxSatDecorator {
    ...
    public void test() throws Exception, ContradictionException, TimeoutException {
        ...
        int[] array_2130656791 = new int[]{2,4,10};
        	int[] array_768359185 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__6).getLits();
        ...
        int[] array_1024874777 = new int[]{3,4,12};
        	int[] array_1354939532 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__11).getLits();
        	for(int ii = 0; ii <array_1024874777.length; ii++) {
        		org.junit.Assert.assertEquals(array_1024874777[ii], array_1354939532[ii]);
        	};
        ...
        int[] array_1802617092 = new int[]{2,5,14};
        	int[] array_634465093 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__16).getLits();
        ...
        int[] array_1308935963 = new int[]{3,5,16};
        	int[] array_227930919 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__22).getLits();
        ...
        int[] array_1749214480 = new int[]{6,8,18};
        	int[] array_443814113 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__26).getLits();
        ...
        int[] array_727859487 = new int[]{7,8,20};
        	int[] array_1350746207 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__31).getLits();
        ...
        int[] array_1507256666 = new int[]{6,9,22};
        	int[] array_1390764368 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__36).getLits();
        ...
        int[] array_82454969 = new int[]{7,9,24};
        	int[] array_1089801689 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__42).getLits();
        ...
        int[] array_1494360137 = new int[]{2,4,6,8,26};
        	int[] array_861863287 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__48).getLits();
        ...
        int[] array_267407017 = new int[]{2,4,10};
        	int[] array_1015252987 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__6).getLits();
        ...
        int[] array_169188043 = new int[]{4,12,3};
        	int[] array_1636271262 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__11).getLits();
        ...
        int[] array_1236722744 = new int[]{2,5,14};
        	int[] array_89108549 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__16).getLits();
        ...
        int[] array_884293419 = new int[]{5,16,3};
        	int[] array_839256037 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__22).getLits();
        ...
        int[] array_1835716233 = new int[]{6,8,18};
        	int[] array_1663993594 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__26).getLits();
        ...
        int[] array_1103456365 = new int[]{20,7,8};
        	int[] array_568510461 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__31).getLits();
        ...
        int[] array_819833656 = new int[]{6,22,9};
        	int[] array_867105381 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__36).getLits();
        ...
        int[] array_626588748 = new int[]{24,9,7};
        	int[] array_381537604 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__42).getLits();
        ...
        int[] array_1303786134 = new int[]{2,4,6,8,26};
        	int[] array_1882681703 = (int[])((org.sat4j.minisat.constraints.cnf.OriginalWLClause)o_test__48).getLits();
