...
public class TestSizeComparatorAmpl {
    ...
    public void testSizeComparatorWithTie() throws Exception {
        ...
        constrs.sort(TestSizeComparatorAmpl.comparator);
    ...
    public void testSizeComparator() throws Exception {
        IVec<Constr> o_testSizeComparator__1 = constrs.push(c4).push(c3).push(c2).push(c1);
        ...
        c5.setActivity(40.0);
        clause.clear();
        IVec<Constr> o_testSizeComparator__40 = constrs.push(c5).push(c6).push(c7).push(c8);
        ...
        constrs.sort(TestSizeComparatorAmpl.comparator);
        Constr o_testSizeComparator__45 = constrs.get(0);
        ...
        Constr o_testSizeComparator__46 = constrs.get(1);
        ...
        Constr o_testSizeComparator__47 = constrs.get(2);
        ...
        Constr o_testSizeComparator__48 = constrs.get(3);
        ...
        Constr o_testSizeComparator__49 = constrs.get(4);
        ...
        Constr o_testSizeComparator__50 = constrs.get(5);
        ...
        Constr o_testSizeComparator__51 = constrs.get(6);
